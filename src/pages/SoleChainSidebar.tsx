...
const SoleChainSidebar: React.FC = () => {
  ...
  return (
    <div className="bg-white h-auto w-1/5 p-4 md:w-1/6 flex flex-col justify-between">
      ...
      <Link to={"/sole-admin/"}>
        <SoleChainSidebarItem icon={<FaHome />} text="Dashboard" />
      </Link>
      <div
        className="group flex items-center justify-between py-2 px-2 mt-4 text-gray-600 cursor-pointer transition-bg hover:bg-orange-500 hover:rounded-md hover:text-white "
      ...
      {isInventoryOpen && (
        <div className="pl-6">
          <Link to="/sole-admin/products">
            <SoleChainSidebarSubItem text="Products" />
          </Link>
          <Link to="/sole-admin/catalogue">
            <SoleChainSidebarSubItem text="Catalogue" />
          </Link>
          <Link to="/sole-admin/brands">
            <SoleChainSidebarSubItem text="Brands" />
          </Link>
          <Link to="/sole-admin/categories">
            <SoleChainSidebarSubItem text="Categories" />
          </Link>
        </div>
      )}
      <Link to={"/sole-admin/users"}>
        <SoleChainSidebarItem icon={<FaUsers />} text="Users" />
      </Link>
      <Link to={"/sole-admin/orders"}>
        <SoleChainSidebarItem icon={<FaShoppingCart />} text="Orders" />
      </Link>
      <Link to={"/sole-admin/banners"}>
        <SoleChainSidebarItem icon={<FaImages />} text="Banners" />
      </Link>
      <SoleChainSidebarItem icon={<FaCog />} text="Settings" />
      <div>
        <button
          className="flex text-xs items-center text-white cursor-pointer bg-red-600 rounded-md py-2 px-2 w-40 mt-4"
...
const SoleChainSidebarItem: React.FC<SoleChainSidebarItemProps> = ({
  ...
  return (
    <div
      className="group flex items-center py-2 px-2 mt-4 text-gray-600 cursor-pointer transition-bg hover:bg-orange-500 hover:rounded-md hover:text-white "
      title={text}
    >
      {icon}
