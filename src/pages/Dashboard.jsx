  ...
  return (
    <div className="bg-gray-100 h-screen p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* Total Outlets Card */}
        <DashboardCard title="Total Outlets" value={systemStats.totalOutlets} />  

        {/* Total Users Card */}
        <DashboardCard title="Total Users" value={systemStats.totalUsers} />
        
        {/* Total Orders Card */}
        <DashboardCard title="Total Orders" value={systemStats.totalOrders} />
