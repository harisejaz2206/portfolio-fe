...
function BillingAndInventoryForm({ selectedProduct }) {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex justify-center items-center">
      ...
      <div className="mb-6 flex items-center justify-center">
        ...
        <h1 className="text-2xl font-semibold text-gray-800 mb-6">Billing and Inventory</h1>

        {/* Card showing selected product */}
        {selectedProduct && (
          <div className="mb-6">
            <div className="bg-gray-200 p-4 rounded-md">
              <div className="text-lg font-semibold mb-2">{selectedProduct}</div>
        ...
        {/* Inventory Details */}
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-2">Inventory Details</h2>
  ...
  />
        ...
        {/* Billing Details */}
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-2">Billing Details</h2>
          {/* Original Price */}
          <div className="mb-2">
        ...
        {formData.isVariant && (
          <div className="flex">
            ...
            {/* Variant Price */}
            <div className="mb-2 flex-grow mr-4">
              <label htmlFor="variantPrice" className="block text-sm font-medium text-gray-700">
                Variant Price
              </label>
              <input
                type="text"
            ...
            <div className="mb-2 flex-grow">
              <label htmlFor="variantUnit" className="block text-sm font-medium text-gray-700">
                Variant Unit
              </label>
              <input
                type="text"
  ...
  <label className="text-sm font-medium text-gray-700">Show Product</label>
  <Toggle
  className='ml-4'
    name="showStatus"
  ...
  />
        ...
        <div className="flex justify-between">
          <Link to="/multi-admin/create-product">
...
export default BillingAndInventoryForm;
