...
function SoleAdminManageOrders() {
    ...
    <div className="bg-gray-100 min-h-screen p-4">
      {currentItems.length > 0 ? (
        <div className="bg-white rounded-lg shadow p-6">
          <h1 className="text-base text-indigo-600 font-semibold mb-4">
            Orders
          </h1>
                ...
                <tr key={order.id}>
                  ...
                  <td className="px-6 py-4 whitespace-no-wrap text-right text-sm font-medium">
                    <div className="flex items-center -ml-4 ">
                      <Link
                        to={`/sole-admin/view-orderdetails/${order.id}`}
...
export default SoleAdminManageOrders;
