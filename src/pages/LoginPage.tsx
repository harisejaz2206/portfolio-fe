...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center h-max bg-white">
      <div className="bg-white rounded-lg mb-4 shadow-lg mt-8 flex w-full max-w-4xl ">
        ...
        <div className="w-2/3 p-14 bg-gray-100">
          ...
          <h1 className="text-2xl font-bold mb-4 text-red-900 text-center">
            Engineering Your E-Pharmacy Revolution
          </h1>
          <form
