          ...
          <div className="text-md text-white mb-8 mt-auto">
            <p>
              <span className="ml-2 block">
                Elevate Your Pharmacy Empire with Our Super Admin Dashboard.
              </span>
            </p>
          </div>
        </div>
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="-mb-4">
              ...
              <InputField
                ...
                name="password"
                type="password"
                className="rounded-md border-gray-300 focus:border-red-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full p-2"
              />
            </div>
            <div className="mb-4 text-right mr-1 text-sm">
              <a className="text-md font-medium text-red-900 hover:underline" href="/superlogin-forgotpassword">
