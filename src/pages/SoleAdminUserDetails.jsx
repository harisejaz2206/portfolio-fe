    ...
    <div className="flex bg-gray-100 p-6 rounded-lg shadow-lg">
      ...
      <div className="bg-white rounded-lg p-4 shadow-md w-1/3">
        ...
        <div className="flex items-center justify-center flex-col">
          ...
          <div className="text-base font-semibold mt-2 text-indigo-700 text-center">
            Amanda Harris
          </div>{" "}
          {/* Center text */}
      ...
      <div className="flex flex-col flex-grow ml-4">
        ...
        <div className="bg-white rounded-lg p-4 shadow-md mb-4">
          <h2 className="text-base text-indigo-600 font-semibold mb-4">
            Order History
          </h2>
          {/* Order History Table */}
          <table className="min-w-full divide-y divide-gray-200 mt-8 text-sm">
            ...
            <thead className="bg-gray-100">
              <tr>
                <th className="px-4 py-2 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                  Order ID
                </th>
                <th className="px-4 py-2 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                  Price
